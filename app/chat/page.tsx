                ...
                >
                  <div className="bg-[#201f1f] border border-white/10 rounded-lg p-6">
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <span className="font-mono text-[11px] uppercase tracking-wider text-neutral-300">Verdict</span>
                      <span className="ml-auto font-mono text-[10px] text-neutral-600 flex items-center gap-2">
                        <span className="material-symbols-outlined text-xs">call_split</span>
                        OmniV-4.2
                      </span>
                    </div>
                    <div className="font-mono text-[14px] text-white leading-relaxed">
                      <StreamingText text={roastData.output} />
                    </div>
                  </div>
                </motion.div>
